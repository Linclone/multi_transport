...
class PurePursuit:
    def __init__(self, path):
        self.path = path
        self.lookahead_distance = 0.1  # 预瞄距离
        self.current_idx = 0
...
if __name__ == '__main__':
    ...
    if flag1 & flag2:
        ...
        print("RRT init...")
        path = RRT_star(map,S,E,45,0.6,85,rigid_size,scan_rate)
        print('RRT Finished! -- ')
        ...
        for gostep in range(1,len(path)):
            ...
            PATH1, PATH2 = path_gen(cur_pos, destination, cur_theta, dest_angle, 20, 2*l_2)
            dest_1 = PATH1[-1]
            dest_2 = PATH2[-1]
            ...
            while norm(destination,cur_pos) > 0.2 :
                v1_out=0
                v2_out=0
                omega1=0
                omega2=0
